...
@Entity()
public abstract class ParkingSpaceGenImpl implements DddEntity, DddAggregate, ParkingSpaceGen {
    ...
    public ParkingSpaceGenImpl(String id, String name, String description, long ownerId, float parkingPricePerHour, Date createdDate, Date lastModifiedDate, boolean activated, boolean blocked, boolean offered, Location location, TimePeriods availabilityPeriods, ParkingSpaceSize parkingSpaceSize) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.ownerId = ownerId;
