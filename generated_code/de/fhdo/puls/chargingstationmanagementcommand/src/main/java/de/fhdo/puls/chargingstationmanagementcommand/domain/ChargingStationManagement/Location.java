...
import de.fhdo.puls.chargingstationmanagementcommand.domain.ChargingStationManagement.gen.LocationGenImpl;
...
public class Location extends LocationGenImpl {
    ...
    public Location(double longitued, double latitude) {
        super(longitued, latitude);
    }
}
