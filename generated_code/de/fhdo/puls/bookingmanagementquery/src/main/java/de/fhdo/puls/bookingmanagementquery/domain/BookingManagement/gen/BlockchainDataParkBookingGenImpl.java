...
public abstract class BlockchainDataParkBookingGenImpl implements DddValueObject, BlockchainDataParkBookingGen {

    public BlockchainDataParkBookingGenImpl() {
    }
    ...
    public BlockchainDataParkBookingGenImpl(long bookingId, long bookerId, String parkingSpaceId, String startOfBooking, String endOfBooking, float bookingPriceTotal, boolean bookingCanceled, String bookingCreatedTimeStamp) {
        this.bookingId = bookingId;
        this.bookerId = bookerId;
        this.parkingSpaceId = parkingSpaceId;
        this.startOfBooking = startOfBooking;
