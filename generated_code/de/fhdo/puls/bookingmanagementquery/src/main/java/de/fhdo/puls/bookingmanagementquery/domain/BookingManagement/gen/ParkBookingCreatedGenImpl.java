...
public abstract class ParkBookingCreatedGenImpl implements DddValueObject, DddDomainEvent, ParkBookingCreatedGen {

    public ParkBookingCreatedGenImpl() {
    }
    ...
    public ParkBookingCreatedGenImpl(long bookingId, Booker booker, ParkingSpace parkingSpace, TimeSlot timeSlot, Date bookingCreatedDate, Date lastModifiedDate, float bookingPricePerHour, float bookingPriceTotal) {
